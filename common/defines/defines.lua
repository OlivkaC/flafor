...
NDiplomacy = {
	...
	DAYS_TO_DECLARE_WAR =  7,						-- Days from start of game before you can DOW anyone
	...
	PEACE_COST_CONCEDE_PROVINCE = 0.7,				-- Demand colonial area province concession.
	...
	PEACE_COST_REVOKE_CORE = 0.1,						-- Revoke a core (scales by province wealth)
	...
	PEACE_COST_GOLD_STEP = 2.5, 						-- _DDEF_PEACE_COST_GOLD_STEP_ Peace Cost for 1 loan size gold of giver
...
NCountry = {
	...
	SIBERIAN_FRONTIER_DAILY_RANGE = 10,
	...
	MAXIMUM_CONDOTTIERI = 30,					-- Base number of units you can rent out
	...
	PARLIAMENT_BACKING_PERCENTAGE = 38,			-- average percent of seats backing an issue (0-100)
	...
	MAX_ACTIVE_POLICIES = 99,						-- how many active policies at once.
	...
	NAT_FOCUS_YEARS_RANK = 4,						-- how many years are removed from nat focus cooldown per gov rank above 1
	...
	PS_ADD_TRIBAL_LAND_EXTRA_COST_PER_PROVINCE = 20,
	PS_FORCE_MARCH = 2,
	...
	PS_IMPROVE_PROVINCE_CAPITAL_DISCOUNT = 0.25,
	PS_SET_PRIMARY_CULTURE = 100,
	PS_ADD_ACCEPTED_CULTURE = 50,
	...
	MAX_NATIONALISM = 10,
	MIN_NATIONALISM = -30,
	YEARS_OF_NATIONALISM = 25, 						-- _CDEF_YEARS_OF_NATIONALISM_; Years of Nationalism
	...
	MONTHS_TO_CORE = 12,							-- How many months it will take to core a province.
...
NEconomy = {
	EDICTS_COST_INCREASE = 4.0,				-- % increase on state maintenance.
	...
	GOLD_MINE_SIZE = 120,							-- Base income from gold mines
	GOLD_MINE_DEPLETION_THRESHOLD = 11,				-- Gold mines above production level or above can be depleted
	GOLD_MINE_DEPLETION_CHANCE = 0.4,					-- Chance of gold mine being depleted (yearly, per production above threshold)
	GOLD_MINE_SIZE_PRIMITIVES = 10,					-- Gold income for very slow techgroups
	TRADE_POWER_HOME_BONUS = 0.1,
	TRADE_POWER_HOME_BONUS_MAX = 1,
	AUTONOMY_AT_DIPLO_ANNEX = 10,					-- Autonomy added when diplo-annexing
	AUTONOMY_AT_CONQUEST = 50,						-- Autonomy added at conquest
	AUTONOMY_AT_CONQUEST_CLAIM = 25,				-- Autonomy added at conquest if you have a claim
	...
	ADVISOR_COST = .75,								-- Advisor cost modifier
	...
	MINIMUM_INTERESTS = 0.0,						-- _EDEF_MINIMUM_INTERESTS_
	...
	MISSIONARY_TIME_BASE = 730,					-- _EDEF_MISSIONARY_TIME_BASE = 10,
...
NMilitary = {
	...
	DAYS_PER_SIEGE_PHASE = 25,						-- How many days each siege phase lasts
	COMBAT_DICE_SIDE = 12,							-- How many sides the dice used in combat has
	...
	LEADER_MIN_PIPS = 2,								-- Min general/admiral pips (total)
	...
	CAV_SUPPRESSION = 0.35,						-- The amount of reduction to unrest for each friendly cavalry regiment in a province
